...
class InvertedResidual(nn.Module):
    def __init__(self, ch_in, ch_out, expand_ratio, stride):
        ...
        layers.extend([
            # depthwise
            conv_dw(hidden_dim, stride=stride),
            # pointwise
...
class MobileNetV2(nn.Module):
    def __init__(self, input_channel=3, n_classes=1000):
        ...
        # t:expand_ratio c:ch_out n:repeat_num s:stride
        self.configs = [
            # t, c, n, s
            [1, 16, 1, 1],
            [6, 24, 2, 2],
        ...
        self.init_conv = conv3x3(input_channel, 32, stride=2)
        ...
        for t, c, n, s in self.configs:
            for i in range(n):
                ...
                layers.append(InvertedResidual(ch_in=input_channel, ch_out=c, expand_ratio=t, stride=stride))
                input_channel = c
